...
/* harmony import */ var _ckeditor_ckeditor5_angular__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ckeditor/ckeditor5-angular */ "./node_modules/@ckeditor/ckeditor5-angular/fesm5/ckeditor-ckeditor5-angular.js");
...
var EachWorkflowComponent = /** @class */ (function () {
    function EachWorkflowComponent(globals, dialog, service) {
    ...
    EachWorkflowComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    EachWorkflowComponent.prototype.ngOnChanges = function () {
    ...
    EachWorkflowComponent.prototype.ngOnDestroy = function () {
        $('.' + this.projectName).connections('remove');
    };
    EachWorkflowComponent.prototype.ngAfterViewInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var nodes_info, _i, nodes_info_1, node, that;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.getProjectInfoSync(this.globals.actual_user.projects[this.projectName])];
                    case 1:
                        nodes_info = _a.sent();
                        for (_i = 0, nodes_info_1 = nodes_info; _i < nodes_info_1.length; _i++) {
                            node = nodes_info_1[_i];
    ...
    EachWorkflowComponent.prototype.nodeInfo_selected = function (project, node_id) {
        var _this = this;
        var project_id = this.globals.actual_user.projects[project];
        // GET ID PROJECT
        this.service.getNodeInfo(project_id, node_id).subscribe(function (result) {
            ...
            if (result.hasOwnProperty('CSRF_TOKEN')) {
                _this.globals.node_csrf_token[project_id][node_id] = result.CSRF_TOKEN;
            }
            else {
                _this.globals.node_csrf_token[project_id][node_id] = null;
            }
            var dialogRef = _this.dialog.open(_node_info_node_info_component__WEBPACK_IMPORTED_MODULE_6__["NodeInfoComponent"], {
                width: '100%',
                data: result
            });
    ...
    EachWorkflowComponent.prototype.NodeCompleted = function (project_id, node_id) {
        this.service.saveNode(project_id, node_id, this.output, this.comments, this.globals.node_csrf_token[project_id][node_id]).subscribe(function (result) {
            console.log(result);
        });
        this.globals.change = !this.globals.change;
        this.display = 'none';
    };
    EachWorkflowComponent.prototype.onCloseHandled = function () {
        this.display = 'none';
    };
    EachWorkflowComponent.prototype.addColumn = function () {
        var randomColumn = Math.floor(Math.random() * this.displayedColumns.length);
        this.columnsToDisplay.push(this.displayedColumns[randomColumn]);
    };
    EachWorkflowComponent.prototype.removeColumn = function () {
        if (this.columnsToDisplay.length) {
            this.columnsToDisplay.pop();
        }
    };
    EachWorkflowComponent.prototype.shuffle = function () {
    ...
    EachWorkflowComponent.prototype.getControl = function (index, fieldName) {
        alert(index + " -- " + fieldName);
    };
    EachWorkflowComponent.ctorParameters = function () { return [
...
var EachWorkflowService = /** @class */ (function () {
    function EachWorkflowService(http, loginService, globals) {
        this.http = http;
     ...
     */
    EachWorkflowService.prototype.getNodeInfo = function (project, node) {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + 'project/' + project + '/node/' + node;
        return this.http.get(url, { withCredentials: true });
    };
    EachWorkflowService.prototype.getResources = function (node) {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + 'node/' + node + '/resources/';
    ...
    EachWorkflowService.prototype.getNodeInfoSync = function (project, node) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + 'project/' + project + '/node/' + node;
                        _a = this;
    ...
    EachWorkflowService.prototype.getProjectInfoSync = function (project) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + 'project/' + project + '/status/';
                        _a = this;
                        return [4 /*yield*/, this.http.get(url, { withCredentials: true }).toPromise()];
                    case 1:
                        _a.token = _b.sent();
    ...
    EachWorkflowService.prototype.saveNode = function (project, node, output, comments, csrftoken) {
    ...
    EachWorkflowService.ctorParameters = function () { return [
...
var EditableComponent = /** @class */ (function () {
    ...
    EditableComponent.prototype.viewModeHandler = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(this.element, 'dblclick').pipe(Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function () {
            _this.mode = 'edit';
    ...
    EditableComponent.prototype.editModeHandler = function () {
        var _this = this;
        var clickOutside$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["fromEvent"])(document, 'click').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (_a) {
            var target = _a.target;
            return _this.element.contains(target) === false;
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1));
        this.editMode$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMapTo"])(clickOutside$), Object(ngx_take_until_destroy__WEBPACK_IMPORTED_MODULE_6__["untilDestroyed"])(this)).subscribe(function (event) { return _this.toViewMode(); });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, globals, service) {
        this.router = router;
        this.globals = globals;
        this.service = service;
        this.success = false;
...
var LoginService = /** @class */ (function () {
    function LoginService(http, cookieService, globals) {
        this.http = http;
    ...
    */
    LoginService.prototype.getUserCSRFToken = function () {
        var httpOptions = {
    ...
    *  https://docs.djangoproject.com/en/2.2/ref/csrf/
    */
    LoginService.prototype.getLogoutCSRFToken = function () {
        var httpOptions = {
            withCredentials: true
        };
    ...
    LoginService.prototype.getProjects = function () {
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + 'user/projects/';
        return this.http.get(url, { withCredentials: true });
    };
    LoginService.prototype.getPOSTHttpOptions = function () {
        var HttpHeadersobj = {};
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(globals, loginService, router) {
        this.globals = globals;
        this.loginService = loginService;
        this.router = router;
    }
    ...
    NavbarComponent.prototype.logout = function () {
        var _this = this;
        this.loginService.getLogoutCSRFToken().subscribe(function (csrf) {
            var csrftoken = null;
            if (csrf.hasOwnProperty('CSRF_TOKEN')) {
                csrftoken = csrf.CSRF_TOKEN;
            }
            _this.loginService.logout(csrftoken).subscribe(function (result) {
                alert("You have logged out successfully.");
                _this.router.navigate(['/']);
            }, function (error) { alert("An error happened while logging out."); });
        }, function (error) { alert("An error happened while getting logout CSRF Token."); });
    };
...
var NodeInfoComponent = /** @class */ (function () {
    // We use this trigger because fetching the list of persons can be quite long,
    // thus we ensure the data is fetched before rendering
    function NodeInfoComponent(el, globals, service, dialogRef, data) {
        this.el = el;
        this.globals = globals;
        this.service = service;
    ...
    NodeInfoComponent.prototype.ngAfterViewInit = function () {
        // Called after ngAfterContentInit when the component's view has been initialized. Applies to components only.
        // Add 'implements AfterViewInit' to the class.
        this.savecomment = true;
        this.savecontent = true;
    };
    NodeInfoComponent.prototype.NodeCompleted = function (project_id, node_id) {
        var _this = this;
        this.service.saveNode(this.info.project, this.info.node_seq, this.info.outputs, this.info.outputs_comments, this.globals.node_csrf_token[project_id][node_id]).subscribe(function (result) {
            _this.globals.change = !_this.globals.change;
        });
        switch (node_id) {
            case 1: {
    ...
    NodeInfoComponent.prototype.NodeEdit = function () {
        this.inline_output = false;
        this.inline_comments = false;
        return false;
    };
    NodeInfoComponent.prototype.onNoClick = function () {
        alert("Eeeeee");
        this.dialogRef.close();
    };
    NodeInfoComponent.prototype.addColumn = function () {
        var randomColumn = Math.floor(Math.random() * this.displayedColumns.length);
        this.columnsToDisplay.push(this.displayedColumns[randomColumn]);
    };
    NodeInfoComponent.prototype.removeColumn = function () {
        if (this.columnsToDisplay.length) {
            this.columnsToDisplay.pop();
        }
    };
    NodeInfoComponent.prototype.shuffle = function () {
        var currentIndex = this.columnsToDisplay.length;
        while (0 !== currentIndex) {
            var randomIndex = Math.floor(Math.random() * currentIndex);
            currentIndex -= 1;
    ...
    NodeInfoComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
        { type: _globals__WEBPACK_IMPORTED_MODULE_2__["Globals"] },
...
var NodeInfoService = /** @class */ (function () {
    function NodeInfoService(http, loginService, globals) {
        this.http = http;
        this.loginService = loginService;
        this.globals = globals;
    }
    NodeInfoService.prototype.saveNode = function (project, node, output, comments, csrftoken) {
        var formData = new FormData();
    ...
    NodeInfoService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _login_login_service__WEBPACK_IMPORTED_MODULE_5__["LoginService"] },
        { type: _globals__WEBPACK_IMPORTED_MODULE_4__["Globals"] }
    ]; };
...
var Node1ProblemFormulationComponent = /** @class */ (function () {
    function Node1ProblemFormulationComponent(service, globals) {
        this.service = service;
        this.globals = globals;
    ...
    Node1ProblemFormulationComponent.prototype.NodeCompleted = function (project_id) {
        var _this = this;
        var node_id = 1;
        this.service.saveNode(this.info.project, this.problem_description, this.globals.node_csrf_token[project_id][node_id]).subscribe(function (result) {
            _this.globals.change = !_this.globals.change;
        });
        this.inline_problem_description = true;
        return false;
    };
    Node1ProblemFormulationComponent.ctorParameters = function () { return [
    ...
    return Node1ProblemFormulationComponent;
}());
...
var Node1ProblemFormulationService = /** @class */ (function () {
    function Node1ProblemFormulationService(http, loginService, globals) {
        this.http = http;
        this.loginService = loginService;
        this.globals = globals;
    }
    ...
    return Node1ProblemFormulationService;
}());
...
var TabsComponent = /** @class */ (function () {
    function TabsComponent(globals) {
        this.globals = globals;
        this.objectKeys = Object.keys;
    }
    TabsComponent.prototype.ngOnInit = function () {
    };
    TabsComponent.prototype.deleteProject = function (project) {
        var index = this.globals.active_projects.indexOf(project, 0);
        if (index > -1) {
    ...
    TabsComponent.prototype.openProject = function (project) {
        if (this.globals.active_projects.indexOf(project, 0) === -1) {
            this.globals.active_projects.push(project);
            this.globals.visible_project = project;
        }
    };
    TabsComponent.prototype.visibleProject = function (project) {
        this.globals.visible_project = project;
    };
...
var WorkflowsComponent = /** @class */ (function () {
    function WorkflowsComponent(globals) {
        this.globals = globals;
    }
    WorkflowsComponent.prototype.ngOnInit = function () {
    };
    WorkflowsComponent.ctorParameters = function () { return [
        { type: _globals__WEBPACK_IMPORTED_MODULE_2__["Globals"] }
    ]; };
