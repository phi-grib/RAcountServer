...
from .views import SaveReportCompoundImage, GenerateReportJson, Overview
...
urlpatterns = [
    ...
    path("RX/project/<int:project>/overview/", Overview.as_view()),
    path("RX/project/<int:project>/report/docx/", GenerateReportDocx.as_view()),
    path("RX/project/<int:project>/report/",GenerateReportJson.as_view()),
